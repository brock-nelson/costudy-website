    ...
    <div className="min-h-screen bg-white dark:bg-[#0a0a0a]">
      ...
      <section className="relative container mx-auto px-4 py-24 md:py-32 overflow-hidden" aria-labelledby="hero-heading">
        ...
        <div className="hero-content text-center max-w-5xl mx-auto relative z-10">
          ...
          {/* Subtitle */}
          <p className="text-xl md:text-2xl text-[#5E6E76] dark:text-gray-200 mb-10 max-w-3xl mx-auto leading-relaxed font-medium">
          ...
          {/* Trust Badge */}
          <div className="mt-12 flex items-center justify-center gap-8 text-sm text-[#92A2AA] dark:text-gray-400">
