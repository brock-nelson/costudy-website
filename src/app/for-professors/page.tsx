  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900">
      ...
      <section className="container mx-auto px-4 py-16">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          <div className="border-l-4 border-blue-600 dark:border-blue-400 pl-6">
            <h3 className="text-xl font-semibold mb-3 text-[#374045] dark:text-gray-100">Save Time on Team Management</h3>
          ...
          <div className="border-l-4 border-blue-600 dark:border-blue-400 pl-6">
            <h3 className="text-xl font-semibold mb-3 text-[#374045] dark:text-gray-100">Real-Time Collaboration Insights</h3>
            <p className="text-[#5E6E76] dark:text-gray-200 leading-relaxed">
          ...
          <div className="border-l-4 border-blue-600 dark:border-blue-400 pl-6">
            <h3 className="text-xl font-semibold mb-3 text-[#374045] dark:text-gray-100">Seamless LMS Integration</h3>
            <p className="text-[#5E6E76] dark:text-gray-200 leading-relaxed">
          ...
          <div className="border-l-4 border-blue-600 dark:border-blue-400 pl-6">
            <h3 className="text-xl font-semibold mb-3 text-[#374045] dark:text-gray-100">Evidence-Based Pedagogy</h3>
            <p className="text-[#5E6E76] dark:text-gray-200 leading-relaxed">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white dark:bg-gray-700 p-6 rounded-lg shadow-md">
              <h3 className="text-xl font-semibold mb-3 text-[#374045] dark:text-gray-100">Smart Team Formation</h3>
              <p className="text-[#5E6E76] dark:text-gray-200 leading-relaxed">
            ...
            <div className="bg-white dark:bg-gray-700 p-6 rounded-lg shadow-md">
              <h3 className="text-xl font-semibold mb-3 text-[#374045] dark:text-gray-100">Peer Assessment</h3>
              <p className="text-[#5E6E76] dark:text-gray-200 leading-relaxed">
            ...
            <div className="bg-white dark:bg-gray-700 p-6 rounded-lg shadow-md">
              <h3 className="text-xl font-semibold mb-3 text-[#374045] dark:text-gray-100">Progress Tracking</h3>
              <p className="text-[#5E6E76] dark:text-gray-200 leading-relaxed">
            ...
            <div className="bg-white dark:bg-gray-700 p-6 rounded-lg shadow-md">
              <h3 className="text-xl font-semibold mb-3 text-[#374045] dark:text-gray-100">Intervention Alerts</h3>
              <p className="text-[#5E6E76] dark:text-gray-200 leading-relaxed">
            ...
            <div className="bg-white dark:bg-gray-700 p-6 rounded-lg shadow-md">
              <h3 className="text-xl font-semibold mb-3 text-[#374045] dark:text-gray-100">Grade Integration</h3>
              <p className="text-[#5E6E76] dark:text-gray-200 leading-relaxed">
      ...
      <section className="container mx-auto px-4 py-16 text-center">
        ...
        <p className="text-xl text-[#5E6E76] dark:text-gray-200 mb-8 max-w-2xl mx-auto leading-relaxed">
